...
(function () {
  ...
  var form = document.querySelector('.lp_contact_form');
  if (!form) return;
  ...
  function validateForm(form) {
    ...
    fields.forEach(function (field) {
      var group = field.closest('.lp_contact_form_field');
  ...
  function handleSubmit(e) {
    ...
    var successEl = form.querySelector('.lp_contact_form_success');
    var errorEl = form.querySelector('.lp_contact_form_error');
  ...
  form.addEventListener('input', function (e) {
    var group = e.target.closest('.lp_contact_form_field');
