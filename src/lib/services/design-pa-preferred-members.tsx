...
export const paPreferredMembers: Service = {
  ...
  meta: {
    ...
    description:
      `Websites for PA Preferred members: Pennsylvania-grown and made farms, food producers, and makers. Farm-stand and market hours up front, the PA Preferred mark and local credentials as trust signals, real photos, and fast on a phone. Custom builds run ${TYPICAL_BAND}, quoted up front.`,
  },
};
