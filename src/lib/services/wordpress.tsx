...
export const wordpress: Service = {
  ...
  price: {
    ...
    body:
      "A WordPress build is priced like every build here: on what it wins for your business, starting at the $3,200 baseline with most landing near $6,200. The difference from the static route is the ongoing side: WordPress needs maintenance, and mine is $550 every six months for updates and small content changes, stated here so it never surprises you.",
    disclaimer: (
      <>
