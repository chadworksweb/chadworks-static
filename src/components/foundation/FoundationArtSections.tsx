// Foundation repair work-of-art sections, reproduced faithfully and RESKINNED to
// the global tokens (CWS directive 2026-06-15). Server components: the faucet
// hero, the why-split with the live browser mockup, the three lanes with their
// SVG vizzes, and the trust framework. The camera teardown + CTA are placed by
// the page. The SVGs are reproduced from the source with the Syne face swapped
// to the global display font (Lexend) and the palette already on indigo/purple.
    ...
    <SectionShell full reveal={false} className="cw-art-hero">
      ...
      <div className="cw-art-hero__content">
        ...
        <h1 className="cw-art-hero__h1">
          Websites for foundation repair contractors <em>that hold up under pressure</em>
        </h1>
        <p className="cw-art-hero__tagline">Optimized for the basement-flood call</p>
        <p className="cw-art-hero__sub">
          Most foundation repair websites lose the job before the homeowner picks
          up the phone. Five seconds to load on mobile, no engineer signoff or
          warranty visible, the phone number buried in a footer image. I build the
          opposite &mdash; and I&apos;ve been doing it for trade businesses since
          the MySpace days.
        </p>
...
export function FoundationBuild() {
  return (
    <SectionShell className="cw-art-section">
      <div className="cw-art-why__split">
        <div>
          ...
          <div className="cw-art-direct-answer">
            Foundation repair contractors need three things from a website: a phone
        ...
        <div className="cw-art-why__right" aria-hidden="true">
          {/* data-nosnippet: this is a fictional foundation repair company, and
              its copy names placeholder towns. Without it Google can lift the
              mock headline into a snippet for a real query, and an assistant
              can quote it as a real business. */}
          <div className="cw-art-mockup" data-nosnippet>
            <div className="cw-art-mockup__chrome">
              <span className="cw-art-mockup__dot" />
              <span className="cw-art-mockup__dot" />
              <span className="cw-art-mockup__dot" />
              <div className="cw-art-mockup__url">foundationworks.com</div>
            </div>
            <div className="cw-art-mockup__body">
              <div className="cw-art-mockup__nav">
                <div className="cw-art-mockup__logo">Foundation<span>Works</span></div>
                <div className="cw-art-mockup__phone">(610) 555-0142</div>
              </div>
              <h3 className="cw-art-mockup__h1">
                Foundation repair &amp; basement waterproofing in <em>Anytown, Everytown &amp; Anytown Heights.</em>
              </h3>
              <div className="cw-art-mockup__meta">
                <span className="cw-art-mockup__badge">State License #XX-072813</span>
                <span className="cw-art-mockup__badge">PE Engineer Signoff</span>
                <span className="cw-art-mockup__badge">Lifetime Warranty</span>
              </div>
              <div className="cw-art-mockup__truck" />
              <div className="cw-art-mockup__row">
                {["Foundation", "Waterproofing", "Crawl Space"].map((h) => (
      ...
      <div className="cw-art-lanes">
        ...
        <div className="cw-art-lane">
          ...
          <div className="cw-art-lane__content">
            ...
            <p className="cw-art-lane__desc">Town names live in the body text and the schema, not just the footer.</p>
            <ul className="cw-art-lane__caps">
        ...
        <div className="cw-art-lane">
          ...
          <div className="cw-art-lane__content">
            <h4 className="cw-art-lane__title">Show the trust signals before the customer asks.</h4>
            ...
            <ul className="cw-art-lane__caps">
              ...
              <li>Google reviews embedded live</li>
          ...
          <div className="cw-art-lane__viz">
            <svg viewBox="0 0 290 168" role="img" aria-labelledby="lane-03-title lane-03-desc" xmlns="http://www.w3.org/2000/svg">
              ...
              <desc id="lane-03-desc">A trust-signal strip showing state license, BBB A-plus, 30-plus five-star reviews, and a PE engineer signoff badge.</desc>
              <rect x="6" y="6" width="278" height="156" rx="12" fill="#ffffff" stroke="rgba(36,57,137,0.10)" strokeWidth="1" />
              ...
              <g transform="translate(22, 42)">
                ...
                <g transform="translate(126, 54)">
                  ...
                  <text x="60" y="26" fontFamily={DISPLAY} fontWeight="800" fontSize="18" fill="#fff" textAnchor="middle">PE</text>
                  <text x="60" y="38" fontFamily={MONO} fontSize="6" letterSpacing="0.18em" fill="rgba(255,255,255,0.85)" textAnchor="middle">SIGNOFF</text>
                </g>
              </g>
      ...
      <div className="cw-art-framework">
        <div className="cw-art-framework__name">Three load-bearing trust signals</div>
        <div className="cw-art-framework__rows">
          <div className="cw-art-framework__row">
            <div className="cw-art-framework__num">1</div>
            <div>
              <strong>Engineer signoff and transferable warranty above the fold.</strong>
              <p>The two trust signals that close the homeowner against US Waterproofing and Basement Systems. PE signoff line says you&apos;re not winging the structural call; transferable warranty says the next owner inherits the fix. Both visible without scrolling, not buried on an About page.</p>
            </div>
          </div>
          <div className="cw-art-framework__row">
            <div className="cw-art-framework__num">2</div>
            <div>
              <strong>Before-and-after gallery on the home page.</strong>
              <p>Foundation repair is sold by visible proof: cracked wall to repaired wall, wet basement to dry basement after the next storm. Every build ships with a real before-after gallery indexed to each service page by job type. Stock photos of generic basements get filtered out by the buyer in three seconds.</p>
            </div>
          </div>
          <div className="cw-art-framework__row">
            <div className="cw-art-framework__num">3</div>
            <div>
              <strong>Mobile load between 2 and 3 seconds.</strong>
              <p>Most foundation sites I audit take 4 to 6 seconds on a mid-range Android. That&apos;s a lost panic lead the night a homeowner finds water in the basement. The realistic target is 2 to 3 seconds, and it&apos;s a hosting and image problem, not a design problem.</p>
            </div>
          </div>
        </div>
      </div>
