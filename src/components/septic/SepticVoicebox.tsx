...
// The thread ITSELF: lead paragraph, the 3-message preview, the full 16 in a
// <details>, and the caption. Extracted so the essay embed
// (<AgencyThreadEmbed />) renders the same markup without the service-page
// eyebrow + heading above it. Single source of truth for the exchange.
export function SepticVoiceboxThread() {
  return (
    <>
      <h3 className="cw-art-voice__subhead">
        Real exchange with a client&apos;s previous agency
      </h3>
      <p className="cw-art-voice__lead">
        <strong>December 2023.</strong> My client{" "}
