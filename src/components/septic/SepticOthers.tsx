// Septic "other industries" cross-link grid, reproduced line-by-line from the
// source marketing page (industry_others) and RESKINNED to the global tokens
// (CWS directive 2026-06-15). Every industry label, description, and href is
// copied verbatim. Server component; the page wraps it, so the root is a <div>.
// Internal-looking hrefs use next/link Link; absolute chadworks.co URLs stay <a>.

import Link from "next/link";

export function SepticOthers() {
  return (
    <div className="cw-art-others full">
      <div className="cw-art-others__inner">
        ...
        <div className="cw-art-others__grid">
          ...
          <Link className="cw-art-others__card" href="/website-design-for-foundation-repair/">
            <div className="cw-art-others__name">Foundation Repair</div>
            <div className="cw-art-others__desc">Waterproofing &middot; crawl space</div>
          </Link>
          <span className="cw-art-others__card cw-art-others__card--disabled">
