...
const QUICK: LeadFormConfig = {
  ...
  fields: [
    ...
    { kind: "email", name: "email", label: "Email", required: true, autocomplete: "email", span: "half" },
    {
      ...
      required: true,
      rows: 4,
      placeholder: "The business, what you'd like to happen, and where it's stuck.",
    },
  ],
};
...
const DETAILED: LeadFormConfig = {
  ...
  fields: [
    ...
    { kind: "text", name: "business", label: "Business Name", span: "half" },
    {
      ...
      span: "full",
      options: [
        { value: "3200-5000", label: "Around $3,200 to $5,000" },
        { value: "6000-10000", label: "Around $6,000 to $10,000" },
        { value: "10000-plus", label: "$10,000 and up" },
    ...
    },
    {
      ...
      required: true,
      rows: 5,
      placeholder: "What the site needs to do, who it's for, and where it's stuck today.",
    },
