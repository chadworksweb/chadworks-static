...
export default async function EssayPage({
  ...
  // full-width thread band between them.
  ...
  const articleJsonLd = {
    ...
    speakable: {
      ...
      cssSelector: [".essay-head__title", ".essay-head__dek"],
    },
  };
  ...
  return (
    <PageComposer jsonLd={[breadcrumbJsonLd, articleJsonLd, blogJsonLd]}>
      ...
      {/* The embedded thread breaks OUT of the reading column: its own shade
          band, full-bleed background, content re-anchored to site width by the
          page-shell grid. Any prose after the token resumes at reading measure
      ...
      <SectionShell className="essay-article essay-article--tail">
        <article className="essay-wrap">
          ...
          {/* AUTHOR BIO -- the visible half of the Person entity in the
              JSON-LD. E-E-A-T has to be readable on the page, not only in the
              schema, so the byline up top and this box down here are the pair
              that back the author claim. Copy is the site's own About line,
          ...
          <aside className="essay-bio">
            ...
            <div className="essay-bio__body">
              ...
              <p className="essay-bio__text">
                ...
                engagements since 2019, and the person you email is the person
                who writes the code. Not the cheapest, deliberately.
              </p>
            </div>
          </aside>
